...
class MassSummationTestCase8(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        # fuel values:
        assert_near_equal(
            self.prob['OEM_wingfuel_mass'], 59444.33382638, tol
        ...
        assert_near_equal(
            self.prob[Aircraft.Fuel.FUEL_SYSTEM_MASS], 1890.52603254, tol
...
class MassSummationTestCase9(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        assert_near_equal(
            self.prob['fuel_mass_min'], 16764.01814222, 0.0012
        ...
        assert_near_equal(
            self.prob[Aircraft.Fuel.WING_VOLUME_DESIGN], 654.38923651, 0.00051
        ...
        assert_near_equal(
            self.prob['OEM_fuel_vol'], 1270.11531073, tol
        )  # modified from GASP value to account for updated crew mass. GASP value is 1273.6
        assert_near_equal(
            self.prob[Mission.OPERATING_MASS], 102565.98185767, tol
...
class BWBMassSummationTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        prob.model.set_input_defaults(
            Aircraft.CrewPayload.ULD_MASS_PER_PASSENGER, 0.0667, units='lbm'
        )
        self.prob.model.set_input_defaults(
    ...
    def test_case1(self):
        ...
        assert_near_equal(prob[Aircraft.CrewPayload.CARGO_CONTAINER_MASS], 1815.0, tol)
