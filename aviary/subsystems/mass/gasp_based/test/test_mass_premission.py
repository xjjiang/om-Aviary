...
class MassSummationTestCase8(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        # fuel values:
        assert_near_equal(
            self.prob['OEM_wingfuel_mass'], 59367.33452732, tol
        ...
        assert_near_equal(
            self.prob[Aircraft.Fuel.FUEL_SYSTEM_MASS], 1885.4440788, tol
...
class MassSummationTestCase9(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        assert_near_equal(
            self.prob['fuel_mass_min'], 16682.09603544, 0.0012
        ...
        assert_near_equal(
            self.prob[Aircraft.Fuel.WING_VOLUME_DESIGN], 652.75152296, 0.00051
        ...
        assert_near_equal(
            self.prob['OEM_fuel_vol'], 1268.47759719, tol
        )  # modified from GASP value to account for updated crew mass. GASP value is 1273.6
        assert_near_equal(
            self.prob[Mission.OPERATING_MASS], 102647.90396443, tol
