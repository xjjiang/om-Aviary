...
def preprocess_options(
    ...
    if Settings.ATMOSPHERE_MODEL not in aviary_options:
        aviary_options.set_val(Settings.ATMOSPHERE_MODEL, meta_data[Settings.ATMOSPHERE_MODEL]['default_value'])
    ...
    if Mission.GRAVITY not in aviary_options: # Check to see if the user has set a gravity profile.
        ...
        aviary_options.set_val(Mission.GRAVITY, val=planet_gravity[0], units=planet_gravity[1]) # contains both value and units as a tuple.
