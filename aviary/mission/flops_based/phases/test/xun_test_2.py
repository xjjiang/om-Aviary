...
class XunGASPOverrideTestCase(unittest.TestCase):
    def setUp(self):
        ...
        # don't need mass
        core_subsystems = get_default_premission_subsystems('GASP', engines)[:-1]
        ...
        # KM: Engine Scale factor is also an input on some other engine components,
        # so that is why it is alwasy present in the model.
